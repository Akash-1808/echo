            ...
            <div className="mb-6">
                <div className="space-y-4">
                    {features.map((features) => (
                        <div className="flex items-center gap-3" key={features.label}>
                            <div className="flex size-8 items-center justify-center rounded-lg border bg-muted">
                                <features.icon className="size-4 text-muted-foreground" />
                            </div>
                        <div>
                            <div className="font-medium text-sm"> {features.label} </div>
                            <div className="text-xs text-muted-foreground">{features.description}</div>
                        </div>
                        </div>
                    ))}
                </div>
