...
const vapiFeatures: Feature[] = [
    ...
    const formSchema = z.object({
        publicApiKey: z.string().min(1, {message: "Public API key "}),
        privateApiKey: z.string().min(1, {message: "Private API key "}),
    })
        ...
        return (
            <Dialog onOpenChange={setOpen} open={open}>
                <DialogContent>
                    ...
                    <DialogFooter>
                        <Button onClick={onSubmit} value={"destructive"}>
                            Disconnect
                        </Button>
                    </DialogFooter>
                </DialogContent>
