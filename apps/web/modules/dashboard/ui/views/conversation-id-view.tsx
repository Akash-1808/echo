...
export const ConversationIdView = ({
    ...
    const handleToggleStatus = async() => {
        ...
        //Cylcle through states: unresolved -> escalated -> resolved -> unresolved
    ...
    if(!conversation || messages.status === "LoadingFirstPage") {
        ...
        <div className="flex h-full flex-col bg-muted">
            ...
            <div className="p-2">
                    <AIInput>
                        <AIInputTextarea 
                        disabled
                        placeholder="Type your response as an opearator..."/>
                        <AIInputToolbar>
                            <AIInputTools />
