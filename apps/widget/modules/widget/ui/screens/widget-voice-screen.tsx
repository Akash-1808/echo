...
export const WidgetVoiceScreen = () => {
 ...
 return (
    <>
     ...
     {transcript.length > 0 ? (
        <AIConversation className="h-full flex-1 overflow-y-scroll">
            <AIConversationContent>
     ...
     <div className="border-t bg-background p-4">
        <div className="flex flex-col items-center gap-y-4">
            {isConnected && (<div className="flex items-center gap-x-2">
               <div className={cn(
                "size-3 rounded-full",
                isSpeaking ? "animate-pulse bg-red-500" : "animate-pulse bg-green-500"
                )} />
